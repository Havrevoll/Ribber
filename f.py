...
def f(t, x, particle, tri, ribs, skalering, get_u, separated = False):
    ...
    if not separated:
        ...
        return dict(drag = drag_component, gravity = gravity_component, dudt = dudt, dxdt=dxdt) #, added_mass = added_mass_component - 0.5 * rho_self_density * dudt, pressure = pressure_component, lift = lift_component,
