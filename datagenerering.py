...
def generate_U_txy(f_span, Umx,Vmx,x,y,I,J,ribs, L, rib_width, kutt=True):
    ...
    if kutt:
        ...
        # lag ein tabell med venstre, høgre, nedste og øvste kuttstad. venstre side er i midten av venstre ribbe. Høgre side er i midten av høgre ribbe. Nede var fyrst rib_width/2, men eg reduserte til 10 * ribbetjukkelsen
        ...
        kutt_kor = [(generated_ribs[0].sum(axis=0)/len(generated_ribs[0]))[0], generated_ribs[1][2][0], ribs[v_r+1,1]-rib_width/2, ribs[v_r+1,1] + 10 * rib_width * 0.02] 
        x1 = x[0,:]
        y1 = y[:,0]
